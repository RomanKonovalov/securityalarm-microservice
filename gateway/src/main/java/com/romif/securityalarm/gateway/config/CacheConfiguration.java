...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        config.setInstanceName("securityalarmgateway");
        ...
        config.getMapConfigs().put("com.romif.securityalarm.gateway.domain.*", initializeDomainMapConfig(jHipsterProperties));
